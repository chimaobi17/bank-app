...
* @see Http/Controllers/Banking/InterbankPageController.php:26
...
* @see Http/Controllers/Banking/InterbankPageController.php:50
...
* @see Http/Controllers/Banking/InterbankPageController.php:69
* @route '/banking/interbank'
*/
