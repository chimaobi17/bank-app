            ...
            <div className="flex flex-col gap-8 px-5 pt-10 pb-10 sm:px-6 lg:px-8 xl:px-0">
                ...
                <header className="flex items-center justify-between animate-in fade-in slide-in-from-top-4 duration-700 lg:mt-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-[11px] font-bold uppercase tracking-widest text-muted-foreground text-left">
                                {greeting},
                            </p>
                    ...
                    <div className="flex items-center gap-2">
                        <Link
                            ...
                            className="relative flex h-11 w-11 items-center justify-center rounded-2xl bg-card border border-border hover:bg-muted transition-all active:scale-90 group"
                        >
                        ...
                        <Link
                            ...
                            className="flex h-11 w-11 items-center justify-center rounded-2xl bg-card border border-border hover:bg-muted transition-all active:scale-90 group"
                        >
                            <HelpCircle size={20} className="text-muted-foreground group-hover:text-primary transition-colors" />
                        </Link>
                    </div>
                </header>
                ...
                <section className="flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-225">
                    <div className="flex items-center justify-between">
                        ...
                        <Link href="/banking/accounts" className="text-[11px] font-black uppercase tracking-widest text-muted-foreground hover:text-primary transition-colors">
                            View All
                        </Link>
                    </div>
                        ...
                        {accounts && accounts.length > 0 ? (
                            accounts.map((acc) => (
                                <Link
                                    key={acc.account_id}
                                    href={`/banking/accounts`}
                                    className="group flex items-center justify-between rounded-3xl border border-border bg-card/60 p-5 transition-all hover:bg-muted hover:border-primary/20"
                                >
                            ...
                            <div className="flex flex-col items-center gap-2 rounded-[2rem] border border-dashed border-border p-8 text-center bg-card/20">
                                <p className="text-xs font-bold text-muted-foreground">No active accounts</p>
                                <Link href="/banking/accounts" className="text-[10px] font-black uppercase tracking-widest text-primary">Open Account</Link>
                            </div>
                        )}
                    </div>
                </section>
                ...
                {cards && cards.length > 0 && (
                    <section className="flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-250">
                        <div className="flex items-center justify-between">
                            <h3 className="text-lg font-black tracking-tight text-foreground">My Cards</h3>
                            <Link href="/banking/cards" className="text-[11px] font-black uppercase tracking-widest text-muted-foreground hover:text-primary transition-colors">
                                Manage
                            </Link>
                        </div>
                    ...
                    <section className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-300">
                        ...
                        <div className="flex flex-col gap-4 lg:grid lg:grid-cols-1 xl:grid-cols-1">
                            {savingsGoals.map((goal, i) => {
                                ...
                                return (
                                    <div key={i} className="glass-card rounded-[2rem] p-6 group hover:bg-muted/50 border border-border bg-card/40 transition-all">
                                        <div className="flex justify-between items-center mb-4">
                                            <div className="flex items-center gap-3">
                                                <div className={`h-10 w-10 rounded-xl ${goal.color} bg-opacity-20 flex items-center justify-center text-foreground`}>
                                                    <TrendingUp size={20} />
                                                </div>
                                        ...
                                        <div className="flex justify-between mt-3">
                                            <span className="text-[10px] font-black text-foreground uppercase tracking-widest">{fmt(goal.current)}</span>
                                            <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Target: {fmt(goal.target)}</span>
                                        </div>
                                    </div>
                                );
                            })}
                ...
                <section className="flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-350">
                    <div className="flex items-center justify-between">
                        <h3 className="text-lg font-black tracking-tight text-foreground">Analytics</h3>
                        <div className="flex items-center gap-3">
                            <button
                                type="button"
                                onClick={() =>
                                ...
                                className="text-[10px] font-black uppercase tracking-widest text-primary transition-colors hover:text-primary/80"
                            >
                                Refresh
                            </button>
                            <Link href="/banking/accounts" className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground hover:text-foreground transition-colors">
                                Last 30 days
                            </Link>
                        </div>
                    </div>
                ...
                <section className="bg-gradient-to-r from-amber-500/10 via-amber-500/5 to-transparent border border-amber-500/20 rounded-[2.5rem] p-6 sm:p-8 flex justify-between items-center animate-in zoom-in-95 duration-700 delay-500 group hover:border-amber-500/40 transition-all cursor-pointer bg-card">
                    <div className="flex flex-col gap-1 text-left">
                        ...
                        <p className="text-xs text-muted-foreground">Get 2.5% cashback on all travel.</p>
                    </div>
                    <ChevronRight className="text-amber-500 transition-transform group-hover:translate-x-1" />
                </section>
                ...
                <section className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-10 duration-700 delay-600">
                    <div className="flex items-center justify-between">
                        ...
                        <Link href="/banking/accounts" className="flex items-center gap-1 text-[11px] font-black uppercase tracking-widest text-muted-foreground hover:text-foreground transition-colors">
                        ...
                        {recentTransactions?.length > 0 ? (
                            recentTransactions.map((tx) => (
                                <div
                                    ...
                                    className="group flex items-center justify-between rounded-3xl border border-border bg-card/60 p-5 transition-all hover:bg-muted"
                                >
                                    <div className="flex items-center gap-4">
                                        <div
                                            className={`flex h-12 w-12 items-center justify-center rounded-2xl transition-colors ${tx.direction === 'debit'
                                                    ? 'bg-muted text-muted-foreground group-hover:bg-red-500/10 group-hover:text-red-500'
                                    ...
                                    <div className="text-right">
                                        <p
                                            className={`text-[15px] font-black tracking-tight ${tx.direction === 'debit' ? 'text-foreground' : 'text-emerald-500'
                                                }`}
                                        >
                            ...
                            <div className="flex flex-col items-center gap-3 rounded-[2rem] border border-dashed border-border bg-card/20 p-10 text-center">
                                ...
                                <p className="text-sm font-bold text-foreground">No recent transactions</p>
